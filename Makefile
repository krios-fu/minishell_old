...
SRCS= $(GNL) ft_envp.c ft_pwd.c minishell.c ft_echo.c ft_parseo.c ft_erro_msg.c ft_cd.c
...
run:
	@clear
	@gcc -Wall -Werror -Wextra -g libft.a libftprintf.a minishell.a -o minishell
	@./minishell
